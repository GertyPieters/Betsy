from models import db, User, Product, Tag, Transaction
import os
...
def populate_test_database():
    ...
    tags = [["Sweaters"], ["Pants"], ["Tshirts"], ["Hats"], ["Socks"], ["Vests"], ["Shorts"], ["Shoes"]]
    ...
    for product in products:
        Product.create(name=product[0], description=product[1], price_per_unit=product[2], quantity=product[3], owner=product[4], tag=product[5])
